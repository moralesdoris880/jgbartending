    ...
    <div className="App" alt="Image by kjpargeter on Freepik">
      ...
      <footer ref={drink}>
        ...
        <div id="footerinfo">
          ...
          <div id="call3"><span className="material-symbols-outlined" style={{fontSize:'24px',marginLeft:'10px',width:'25px',height:'25px'}}>mail</span><span className="number"><a className='phonenumber' href='mailto:andradejc82@gmail.com'>andradejc82@gmail.com</a></span></div>
        </div>
      </footer>
